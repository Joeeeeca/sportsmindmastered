    ...
    <section id="content" className="w-full py-16 md:py-20">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-6xl">
          ...
          {/* Video Grid */}
          <div className="grid gap-12 md:gap-8 md:grid-cols-2 text-center md:text-left">
            {/* Video 1 */}
            <div className="group space-y-4 flex flex-col items-center md:items-start">
              <div className="relative aspect-video w-full overflow-hidden rounded-lg bg-muted shadow-lg transition-shadow group-hover:shadow-xl">
                <video
                  ...
                  controls
                  poster="/sportsmindmastered/Simon-thumbnail-one.png"
                >
            ...
            <div className="group space-y-4 flex flex-col items-center md:items-start">
              <div className="relative aspect-video w-full overflow-hidden rounded-lg bg-muted shadow-lg transition-shadow group-hover:shadow-xl">
                <video
                  className="h-full w-full object-cover"
                  controls
                  poster="/sportsmindmastered/Simon-thumbnail-two.png"
                >
